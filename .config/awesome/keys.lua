...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "e", function () awful.spawn(os.getenv("HOME") .. "/.bin/powermenu.sh") end,
    ...
    awful.key(
        { modkey, }, "i",
        function ()
            awful.spawn("rofimoji -p --rofi-args \"-theme .config/rofi/themes/rofimoji.rasi\"")
        end,
